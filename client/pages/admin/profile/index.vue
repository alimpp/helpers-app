<template>
    <div class="flex flex-column">
        <BaseBreadCrumbs />
        <div class="flex w-100" :class="{'flex-column' : width < 1200}">

          <div class="w-50 flex flex-column pt-20 px-5" :class="{'w-100' : width < 1200}">
          ...
          <div class="flex flex-column w-50 px-5" :class="{'w-100' : width < 1200}">
            <BaseInput
                v-for="item in form"
